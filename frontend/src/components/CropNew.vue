<template>
    ...
    <div class="crop-register">
        ...
        <input type="number" inputmode="numeric" v-model="state.area" placeholder="Área total del cultivo */">
        <input type="number" v-model="state.plants_m2" placeholder="Número de plantas por metro cuadrado */">
        <label><strong>Número de plantas por metro cuadrado</strong></label>
        <div class="input-container">
            <select v-model="state.plants_m2" id="plants_m2">
