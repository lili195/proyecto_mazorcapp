...
export default {
	...
	setup() {
		...
		const rules = computed(() => {
			return {
				id_crop: {
					required: helpers.withMessage('Por favor ingrese un identificador', required),
				},
				start_date: {
					required: helpers.withMessage('Por favor elija una fecha de inicio de siembra', required),
				},
				area: {
